...
/**
 * Created by laxba on 11/22/2019.
 */
public class Scan_SQLi {
    ...
    public void scanSQLi(final Element element, final String urlAction, final String[] payload, final HttpClient cClient) throws Exception {
