 ...
 */
public class ScanLFI extends AsyncTask<Void, String, Void> {
    ...
    public ScanLFI(Element ElementScan, String URLScan, String[] PayloadScan, HttpClient Client) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            scanLFI(mElementScan, mURLScan, mPayloadScan, mClient);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    private void scanLFI(final Element element, final String urlAction, final String[] payload, final HttpClient cClient) throws Exception {
